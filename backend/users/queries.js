...
const getUsersByUsername = 'SELECT username, first_name, email, TO_CHAR(birthday, \'YYYY/MM/DD HH:MM:SS\') AS "birthday" ,TO_CHAR(membership, \'YYYY/MM/DD HH:MM:SS\') AS "membership", session_num, isorthodox, picture FROM users WHERE username = $1';
