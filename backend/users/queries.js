...
const getUsersByUsername = 'SELECT username, first_name, email, TO_CHAR(birthday, \'YYYY/MM/DD HH:MM:SS\') ,TO_CHAR(membership, \'YYYY/MM/DD HH:MM:SS\'), session_num, isorthodox, picture FROM users WHERE username = $1';
