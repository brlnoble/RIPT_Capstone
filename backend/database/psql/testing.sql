...
INSERT INTO sessions(session_id, username, category, datetime, duration, uppercut, hook, straight)
VALUES (1, 'test', 'Endurance', '2004-10-19 10:23:54', '0 0:02:30', '{
        	"force": 
                {"avg" : 400,
                "quads": 
                    {"q1": 100,
        ...
        "stability": {
                            "avg": 70,
                            "chartData": [75,84,80,92,77,65,74,53,45,58,61,65,63,72] 
                        }
        }', 
       '{"force": {
            "avg": 250, 
...
'{
    ...
    "stability": {
        "avg": 70,
        "chartData": [75,84,80,92,77,65,74,53,45,58,61,65,63,72,75,84,80,92,77,65,74,53,45,58,61,65,63,72]
    }
}',
'{
                        "force": {
...
INSERT INTO sessions
VALUES (3, 'GingaNinja', 'Personalized', '2023-02-24 10:32:00', '0 0:03:00',
'{
    "force": 
          {"avg" : 250,
          "quads": 
...
INSERT INTO sessions
VALUES (12345, 'SlimShady', 'Speed', '2023-02-23 15:09:00', 
'0 0:03:00', 
'{
    "force": 
          {"avg" : 250,
